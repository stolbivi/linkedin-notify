...
export const Loader: React.FC<Props> = ({show,className, heightValue}) => {

    return (
        <React.Fragment>
            {show &&
            <div className={"loader" + (className ? " " + className : "")} style={{display: "flex", ...(heightValue && { height: heightValue }) }}>
