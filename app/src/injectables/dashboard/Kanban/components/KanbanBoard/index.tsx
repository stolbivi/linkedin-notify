                ...
                <div className="button-container">
                    ...
                    <div className="right-button-container">
                      <div>
                        ...
                        <button className={`btn list-btn ${listView ? "" : "opacity-60"}`} onClick={listViewClickHandler}>
                          List View
                        </button>
                      </div>
                      <div>
                        ...
                        <button className={`btn card-btn ${listView ? "opacity-60" : ""}`} onClick={cardViewClickHandler}>
                          Card View
                        </button>
                      </div>
                      <button className="share-button" onClick={()=>messagesClickHandler(null)}>
                        <svg className="icon-color" style={{marginRight:"23px"}} width="16" height="17" viewBox="0 0 16 17" xmlns="http://www.w3.org/2000/svg">
                ...
                </div>
                {
                  listView?
                      (
                          <>
                            <div className="body2">
                              <table className="table rounded table-striped list-table table-custom">
                                      <thead>
                                        <tr>
                                      ...
                                      <tbody>
                                      {
                                        cards.map((card) => (
                                            <tr className="job-column job-table-row" key={card.id}>
                                              ...
                                              <td>
                                                <button className="btn action-btn-color" onClick={()=>messagesClickHandler(card.conversationUrn)}>
                                                ...
                                                <button className="btn action-btn-color" onClick={()=>onNotesClick(card.userId, card.profileId)}>
                                                  <svg className="icon-color" width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
