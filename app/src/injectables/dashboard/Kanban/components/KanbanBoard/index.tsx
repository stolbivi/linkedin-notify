                ...
                <div className="button-container">
                    ...
                    <div className="right-button-container">
                      <div>
                        ...
                        <button id="kanban-list-view-btn" className={`btn list-btn ${listView ? "" : "opacity-60"}`} onClick={listViewClickHandler}>
                          List View
                        </button>
                      </div>
                      <div>
                      ...
                      <button id="kanban-message-btn" className="share-button" onClick={(event)=>messagesClickHandler(event,null)}>
