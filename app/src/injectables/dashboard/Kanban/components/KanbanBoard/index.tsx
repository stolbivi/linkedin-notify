              ...
              <>
                <div className="button-container">
                    ...
                    <div className="right-button-container">
                      <button className="btn" onClick={() => setListView(true)}>
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <path d="M14 6.83337H2C1.72667 6.83337 1.5 6.60671 1.5 6.33337C1.5 6.06004 1.72667 5.83337 2 5.83337H14C14.2733 5.83337 14.5 6.06004 14.5 6.33337C14.5 6.60671 14.2733 6.83337 14 6.83337Z" fill="#585858"/>
                          <path d="M14 10.1666H2C1.72667 10.1666 1.5 9.93996 1.5 9.66663C1.5 9.39329 1.72667 9.16663 2 9.16663H14C14.2733 9.16663 14.5 9.39329 14.5 9.66663C14.5 9.93996 14.2733 10.1666 14 10.1666Z" fill="#585858"/>
                        ...
                        <span style={{paddingLeft: "3px"}}>List View</span>
                      </button>
                      <button className="btn" onClick={() => setListView(false)}>
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M10.54 13.4533C10.3667 13.4533 10.1867 13.4466 9.99338 13.4266C9.64671 13.4 9.25338 13.3333 8.84671 13.2333L7.72671 12.9666C4.65338 12.24 3.64671 10.6133 4.36671 7.54664L5.02005 4.7533C5.16671 4.11997 5.34005 3.60664 5.55338 3.17997C6.70005 0.813303 8.89338 1.02664 10.4534 1.3933L11.5667 1.6533C13.1267 2.01997 14.1134 2.59997 14.6667 3.48664C15.2134 4.3733 15.3 5.5133 14.9334 7.0733L14.28 9.85997C13.7067 12.3 12.5134 13.4533 10.54 13.4533ZM8.74671 2.16664C7.63338 2.16664 6.92671 2.62664 6.45338 3.6133C6.28005 3.9733 6.12671 4.41997 5.99338 4.97997L5.34005 7.7733C4.74671 10.2933 5.43338 11.3933 7.95338 11.9933L9.07338 12.26C9.43338 12.3466 9.77338 12.4 10.08 12.4266C11.8867 12.6066 12.7934 11.8133 13.3 9.6333L13.9534 6.84664C14.2534 5.55997 14.2134 4.65997 13.8134 4.0133C13.4134 3.36664 12.6267 2.92664 11.3334 2.62664L10.22 2.36664C9.66671 2.2333 9.17338 2.16664 8.74671 2.16664Z" fill="#909090"/>
                          <path d="M5.55353 14.8334C3.8402 14.8334 2.74686 13.8067 2.04686 11.64L1.19353 9.0067C0.246864 6.07337 1.09353 4.42003 4.01353 3.47337L5.06686 3.13337C5.41353 3.0267 5.67353 2.95337 5.90686 2.91337C6.09353 2.87337 6.28686 2.9467 6.4002 3.10003C6.51353 3.25337 6.53353 3.45337 6.45353 3.6267C6.2802 3.98003 6.12686 4.4267 6.0002 4.9867L5.34686 7.78003C4.75353 10.3 5.4402 11.4 7.9602 12L9.0802 12.2667C9.4402 12.3534 9.7802 12.4067 10.0869 12.4334C10.3002 12.4534 10.4735 12.6 10.5335 12.8067C10.5869 13.0134 10.5069 13.2267 10.3335 13.3467C9.89353 13.6467 9.3402 13.9 8.6402 14.1267L7.58686 14.4734C6.8202 14.7134 6.15353 14.8334 5.55353 14.8334ZM5.18686 4.1467L4.32686 4.4267C1.94686 5.19337 1.3802 6.31337 2.14686 8.70003L3.0002 11.3334C3.77353 13.7134 4.89353 14.2867 7.27353 13.52L8.32686 13.1734C8.36686 13.16 8.4002 13.1467 8.4402 13.1334L7.73353 12.9667C4.6602 12.24 3.65353 10.6134 4.37353 7.5467L5.02686 4.75337C5.07353 4.54003 5.12686 4.33337 5.18686 4.1467Z" fill="#909090"/>
                        </svg>
                        <span style={{paddingLeft: "3px"}}>Card View</span>
                      </button>
