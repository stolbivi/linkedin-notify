...
import {deleteJob, getAssignedJobsById, getJobs, getTheme, postJob, SwitchThemePayload, updateJob} from "../../actions";
                                    ...
                                    <>
                                        <form onSubmit={handleSaveField}>
                                            <div style={{display: "flex"}}>
                                                <svg style={{marginTop: "3px"}} className="icon-color" width="4"
                                                     height="7" viewBox="0 0 4 7" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M3.5 1L1 3.5L3.5 6" stroke="#383637" strokeLinecap="round"
                                                          strokeLinejoin="round" fill="none"/>
                                                </svg>
                                                <h3 className={"job-back-text kanban-title"}
                                                    onClick={returnHandler}>Jobs List</h3>
                                            </div>
                                            {detailsView ? (
                                                <>
                                                    ...
                                                    <div className="button-container">
                                                        <button
                                                            className={`button ${activeButton === "Candidates" ? 'active' : ''}`}
                                                        ...
                                                        <>
                                                            <div className="edit-container">
                                                                <div className="edit-col">
                                                                    <span className="edit-col-text"
                                                                          style={{paddingLeft: "4px"}}>Type</span>
                                                                    {
                                                                        detailsView ? (
                                                                            <div>
                                                                                <svg style={{marginBottom: "5px"}}
                                                                                    ...
                                                                                    <path
                                                                                        d="M9.03332 13.4399C8.85998 13.5133 8.67332 13.5799 8.47332 13.6466L7.41998 13.9933C4.77332 14.8466 3.37998 14.1333 2.51998 11.4866L1.66665 8.85328C0.813317 6.20661 1.51998 4.80661 4.16665 3.95328L5.19332 3.61328C5.06665 3.93328 4.95998 4.29995 4.85998 4.71328L4.20665 7.50661C3.47332 10.6466 4.54665 12.3799 7.68665 13.1266L8.80665 13.3933C8.87998 13.4133 8.95998 13.4266 9.03332 13.4399Z"
                                                                                        fill="#909090"/>
                                                                                    <path
                                                                                        d="M11.4467 2.13996L10.3334 1.87996C8.1067 1.3533 6.78004 1.78663 6.00004 3.39996C5.80004 3.80663 5.64004 4.29996 5.50671 4.86663L4.85337 7.65997C4.20004 10.4466 5.06004 11.82 7.84004 12.48L8.96004 12.7466C9.3467 12.84 9.70671 12.9 10.04 12.9266C12.12 13.1266 13.2267 12.1533 13.7867 9.74663L14.44 6.95996C15.0934 4.1733 14.24 2.7933 11.4467 2.13996Z"
                                                                                        fill="#909090"/>
                                                                                </svg>
                                                                                <span
                                                                                    className="details-span-col">{type}</span>
                                                                            </div>
                                                                        ) : (
                                                                ...
                                                                <div className="edit-col">
                                                                    <span className="edit-col-text"
                                                                          style={{paddingLeft: "4px"}}>Geography</span>
                                                                    {
                                                                        detailsView ? (
                                                                            <div>
                                                                                <svg style={{
                                                                ...
                                                                <div className="edit-col">
                                                                    <span className="edit-col-text"
                                                                          style={{paddingLeft: "10px"}}>Company Name</span>
                                                                    {detailsView ? (
                                                                        <div>
                                                                            <svg style={{
                                                                                marginBottom: "5px",
                                                                ...
                                                                <div className="edit-col">
                                                                    <span className="edit-col-text"
                                                                          style={{paddingLeft: "10px"}}>Salary</span>
                                                                    {detailsView ? (
                                                                        <div>
                                                                            <svg style={{
                                                                                marginBottom: "5px",
                                                                                ...
                                                                                marginRight: "4px"
                                                                                 ...
                                                                                 xmlns="http://www.w3.org/2000/svg">
                                                                                <path
                                                                                    d="M9.79338 0.333374H4.20671C1.78004 0.333374 0.333374 1.78004 0.333374 4.20671V9.79338C0.333374 12.22 1.78004 13.6667 4.20671 13.6667H9.79338C12.22 13.6667 13.6667 12.22 13.6667 9.79338V4.20671C13.6667 1.78004 12.22 0.333374 9.79338 0.333374ZM8.50671 7.00004C9.02671 7.18004 9.72004 7.56004 9.72004 8.75337C9.72004 9.78004 8.92004 10.6134 7.93337 10.6134H7.50004V11C7.50004 11.2734 7.27337 11.5 7.00004 11.5C6.72671 11.5 6.50004 11.2734 6.50004 11V10.6134H6.26004C5.16671 10.6134 4.28004 9.68671 4.28004 8.55337C4.28004 8.28004 4.50004 8.05337 4.78004 8.05337C5.05337 8.05337 5.28004 8.28004 5.28004 8.55337C5.28004 9.14004 5.72004 9.61337 6.26004 9.61337H6.50004V7.35337L5.49337 7.00004C4.97337 6.82004 4.28004 6.44004 4.28004 5.24671C4.28004 4.22004 5.08004 3.38671 6.06671 3.38671H6.50004V3.00004C6.50004 2.72671 6.72671 2.50004 7.00004 2.50004C7.27337 2.50004 7.50004 2.72671 7.50004 3.00004V3.38671H7.74004C8.83337 3.38671 9.72004 4.31337 9.72004 5.44671C9.72004 5.72004 9.50004 5.94671 9.22004 5.94671C8.94671 5.94671 8.72004 5.72004 8.72004 5.44671C8.72004 4.86004 8.28004 4.38671 7.74004 4.38671H7.50004V6.64671L8.50671 7.00004Z"
                                                                                    fill="#909090"/>
                                                                            </svg>
                                                                            <span
                                                                                className="details-span-salary-col">{salary}</span>
                                                                        </div>
                                                                    ) : (
                                                                        <input
                                                                            required={true}
                                                                ...
                                                                <div className="edit-col">
                                                                    <span className="edit-col-text"
                                                                          style={{paddingLeft: "10px"}}>Hiring Contact</span>
                                                                    {
                                                                        detailsView ? (
                                                                            <span style={{marginLeft: "10px"}}
                                                                                  className="details-span-col">{hiringContact}</span>
                                                                        ) : (
                                                                            <input required={true}
                                                                ...
                                                                <div className="edit-col">
                                                                    <span className="edit-col-text"
                                                                          style={{paddingLeft: "4px"}}>Status</span>
                                                                    {
                                                                        detailsView ? (
                                                                            <span style={{marginLeft: "4px"}}
                                                                                  className="details-span-col">{status}</span>
                                                                        ) : (
                                                                            <select required={true}
                                                                                    className="edit-select"
                                                                                    name="dropdown"
                                                            ...
                                                            <div className="edit-container-lower">
                                                                <div className="edit-container-internal">
                                                                    <div className="edit-description">
                                                                        <div
                                                                            className="edit-description-text">Description
                                                                        </div>
                                                                        {
                                                                            detailsView ? (
                                                                                <span
                                                                                    className="details-span-col"> {description}</span>
                                                                            ) : (
                                    ...
                                    <>
                                        ...
                                        <table className="table table-striped jobs-table table-custom">
                                            ...
                                            <tr>
                                                ...
                                                <th scope="col" className="job-column job-table-heading">Hiring
                                                    Contact
                                                </th>
                                            ...
                                            <tbody>
                                            {
                                                filteredFields?.length == 0
                                                    ...
                                                    filteredFields?.map((field) => (
                                                        <tr key={field.id} className="job-column job-table-row"
                                                            onClick={() => openDetailsView(field)}>
                                                            <td>
                                                                {field.title}
                                                            </td>
                                                            <td>
