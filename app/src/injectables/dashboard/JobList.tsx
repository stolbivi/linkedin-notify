                                ...
                                <>
                                    <div style={{display: "flex"}}>
                                        <svg width="4" style={{marginTop: "3px"}} height="7" viewBox="0 0 4 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M3.5 1L1 3.5L3.5 6" stroke="#383637" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>
                                        <h3 className={"job-back-text"}>Jobs List</h3>
                                    </div>
                                    <h1 className={"edit-header-text"}>Edit Job Name</h1>
                                    <div className="edit-container">
                                        <div className="edit-col">
                                            <span className="edit-col-text">Type</span>
                                            <select className="edit-select" name="dropdown" id="1">
                                        ...
                                        <div className="edit-col">
                                            ...
                                            <input className="edit-input" type="text" placeholder="Company Name"/>
                                        </div>
                                        <div className="edit-col">
                                            <span className="edit-col-text">Salary</span>
                                            <input className="edit-input" type="text" placeholder="Salary"/>
                                        </div>
                                        <div className="edit-col">
                                            <span className="edit-col-text">Hiring Contact</span>
                                            <input className="edit-input" type="text" placeholder="Hiring Contact"/>
                                        </div>
                                        <div className="edit-col">
                                    ...
                                    <div className="edit-container-lower">
                                        <div className="edit-container-internal">
                                            <div className="edit-description">
                                                ...
                                                <textarea className="edit-description-input" placeholder="Enter Description"/>
                                            </div>
                                            <div className="edit-buttons">
                                                <button className="reset-button">Reset</button>
                                                <button className="confirm-button" onClick={(()=>{setIsEditMode(false)})}>Confirm</button>
                                            </div>
                                        </div>
                                    </div>
                                </>
