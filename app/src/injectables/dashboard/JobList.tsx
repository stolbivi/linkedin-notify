                                        ...
                                        {Object.keys(field).map((key) => {
                                            ...
                                            return (<td key={key}>
                                                    {editableField && editableField.id === field.id  ? (
                                                        inputType === "select" ? (
                                                            <select value={editableField[key]}
                                                                    onChange={(e) => handleFieldChange(key, e.target.value)}>
                                                                {Object.entries(inputType === "type" ? typesDropdown : inputType === "geography" ? geographyDropdown : statusDropdown).map(([key, value]) => (
